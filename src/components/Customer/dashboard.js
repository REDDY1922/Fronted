...
function CustomerDashboard({ setCart }) {
  ...
  return (
    <div style={{ 
      ...
      <NavbarComponent func={searchBooks} /><br /><br /><br /><br /><br />
      <Row>
        <div className="col-md-4">
          <Card style={{ 
            ...
            <Card.Header style={{ backgroundColor: "#343a40", color: "#fff" }}>
              <h4 style={{ fontFamily: "Arial, sans-serif", margin: 0, color: "#fff" }}>Categories</h4>
            </Card.Header>
            <ListGroup>
          ...
          {filteredBooks.length > 0 ? (
            <>
                    ...
                    <Card style={{ 
                      ...
                      <Card.Body>
                        ...
                        <div>
                          ...
                          <Button onClick={() => handleBooks(b)} style={{ width: 200, alignSelf: "center", margin: 15, backgroundColor: "#007bff", color: "#fff", border: "none" }}>Add to cart</Button>
                        </div>
                      </Card.Body>
                    </Card>
                  </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <Pagination>
                  <Pagination.Prev onClick={handlePrev} style={{ cursor: currentPage > 1 ? 'pointer' : 'not-allowed', backgroundColor: "#007bff", color: "#fff" }} />
                  ...
                  <Pagination.Next onClick={handleNext} style={{ cursor: currentPage < Math.ceil(filteredBooks.length / booksPerPage) ? 'pointer' : 'not-allowed', backgroundColor: "#007bff", color: "#fff" }} />
                </Pagination>
              </div>
            </>
          ) : (
